          ...
          <p class="fs-12 mb-0">Admin</p>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="./app-profile.html" class="dropdown-item ai-icon">
                                        ...
                                        <span class="ml-2">{{ Auth::user()->name ?? '' }} Profile </span>
                                    </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <a href="javascript:void(0)" class="add-menu-sidebar" data-toggle="modal"
                    data-target="#addOrderModalside">+ New Event</a>
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ route('types.index') }}">
                            <i class="flaticon-381-networking"></i>
                            <span class="nav-text">Events Types</span>
                        </a>
                    </li>
                    <li><a href="{{ route('faqs.index') }}">
                            <i class="flaticon-381-networking"></i>
                            <span class="nav-text">Frequentyly Asked Questions</span>
                        </a>
                    </li>
